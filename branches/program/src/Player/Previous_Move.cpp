...
Previous_Move::Previous_Move(Position beg_position, Position end_position, std::shared_ptr<Piece> piece_in_end_position)
: beg_position(beg_position), end_position(end_position), piece_in_end_position(piece_in_end_position){}
